...
public class UntitledTestCase {
  ...
  public void testUntitledTestCase() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='/reserves/{restaurantId}'])[2]/following::*[name()='svg'][1]")).click();
    driver.findElement(By.cssSelector("#operations-reservation-controller-getCustomerReservations > div.opblock-summary.opblock-summary-get > button.opblock-summary-control > svg.arrow > use")).click();
    ...
    driver.findElement(By.cssSelector("#operations-reservation-controller-getCustomerReservations > div.opblock-summary.opblock-summary-get > button.opblock-summary-control > svg.arrow > use")).click();
    driver.findElement(By.cssSelector("#operations-reservation-controller-cancelReservation > div.opblock-summary.opblock-summary-post > button.opblock-summary-control > svg.arrow > use")).click();
