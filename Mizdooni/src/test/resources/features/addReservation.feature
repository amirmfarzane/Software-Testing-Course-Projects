Feature: Add Reservations
  ...
  Scenario: Adding a reservation and checking correct assigned restaurant
  ...
  Scenario Outline: Adding reservation when reservation date is current or in the future
    Given a restaurant named "Shila fastfood" with a table for 4 exists
    And a user named "client1" exists
